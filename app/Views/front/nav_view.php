...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: black; border: 0px 0px 10px 0px; ">
            ...
            <nav class="navbar-nav navDos ml-auto h-100">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="" id="navbarDropdown" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false"><?php echo(session('nombreUsu'));?>
                ...
                <?php else: ?>
                    ...
                    <div class="styleModal">
                        ...
                        <div>
                            <ul style="padding:0%; margin:0%; width:auto; text-decoration: none;">
                                <nav class="item" >
                                    <a href="<?php echo base_url('');?>/carrito" class="">
                                        <img src="<?php echo base_url('');?>/assets/img/2345.png" alt="" width="35">
                                    </a>
                    ...
                    <div class="modal-dialog">
                        ...
                        <form method="post" action="<?php echo base_url('iniciarSes')?>" class="formulario " style=" padding: 1%;margin:auto; margin-top: 5%;
                        margin-bottom: 5%; ">
...
<div class="alert alert-warning" role="alert">
    <a href="<?php echo base_url('iniciar'); ?>" class="alert-link">Iniciar sesion</a>
    <?=session('registrarComoAdmin.body')?>
</div>
<?php endif?>
